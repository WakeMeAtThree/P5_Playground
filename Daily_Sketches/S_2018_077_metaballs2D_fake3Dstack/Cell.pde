class Cell {
  ...
  Cell(float x, float y, float z,float space) {
    //Center point
    center = new PVector(x, y, z);

    //Corner Points
    A = center.copy().add(new PVector(-space/2, -space/2, space/2));
    B = center.copy().add(new PVector(space/2, -space/2, space/2));
    C = center.copy().add(new PVector(-space/2, space/2, space/2));
    D = center.copy().add(new PVector(space/2, space/2, space/2));

    //Mid Points
    AB = center.copy().add(new PVector(0, -space/2, space/2));
    CD = center.copy().add(new PVector(0, space/2, space/2));
    AC = center.copy().add(new PVector(-space/2, 0, space/2));
    BD = center.copy().add(new PVector(space/2, 0, space/2));
  }
